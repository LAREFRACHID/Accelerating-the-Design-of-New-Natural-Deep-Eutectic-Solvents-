...
input_file = "Density_selected_ind_descriptors____.xlsx"
output_rdkit_file = "DES_density_with_RDKit_descriptors.xlsx"

target_column = "Density_g_per_cm3"
...
corr_matrix.to_excel("Density_correlation_matrix_all_descriptors.xlsx")
...
pd.DataFrame(high_corr_pairs).to_excel(
    "Density_highly_correlated_pairs_above_095.xlsx",
    index=False
)
...
pd.DataFrame({"Removed_correlated_features": to_drop}).to_excel(
    "Density_removed_correlated_features.xlsx",
    index=False
)
...
importance_df.to_excel(
    "Density_feature_importance_all_initial_with_temperature.xlsx",
    index=False
)
...
experimental_importance = importance_df[
    importance_df["feature"].isin(["Temperature", "x1", "x2"])
].copy()

experimental_importance.to_excel(
    "Density_feature_importance_experimental_variables.xlsx",
    index=False
)
...
selected_df = pd.concat(
    [
        df_rdkit[["Density"]].reset_index(drop=True),
...
selected_df.to_excel(
    "Density_selected_features_balanced_original_values.xlsx",
    index=False
)

selected_df.to_csv(
    "Density_selected_features_balanced_original_values.csv",
    index=False
)
...
comparison_df.to_excel(
    "Density_descriptor_comparison_comp1_comp2.xlsx",
    index=False
)
...
selected_corr.to_excel(
    "Density_correlation_matrix_selected_features_original_values.xlsx"
)
...
pd.DataFrame(selected_corr_pairs).to_excel(
    "Density_selected_features_correlated_pairs_above_080_original_values.xlsx",
    index=False
)
...
pd.DataFrame(grid.cv_results_).to_excel(
    "Density_gridsearch_RF_results.xlsx",
    index=False
)
...
metrics_df.to_excel(
    "Density_model_metrics_train_test.xlsx",
    index=False
)
...
predictions_df.to_excel(
    "Density_predictions_test_RF.xlsx",
    index=False
)
...
cv_results_summary.to_excel(
    "Density_cross_validation_metrics_RF.xlsx",
    index=False
)
...
final_importance_df.to_excel(
    "Density_feature_importance_final_selected_RF.xlsx",
    index=False
)
...
final_importance_df[
    ...
    "Density_feature_importance_final_experimental_variables.xlsx",
    index=False
)
...
final_importance_df[
    ...
    "Density_feature_importance_final_comp1.xlsx",
    index=False
)
...
final_importance_df[
    ...
    "Density_feature_importance_final_comp2.xlsx",
    index=False
)
...
family_importance.to_excel(
    "Density_feature_importance_by_descriptor_family.xlsx",
    index=False
)
...
selected_features_df.to_excel(
    "Density_selected_features_final_ordered.xlsx",
    index=False
)
...
print("DES_density_with_RDKit_descriptors.xlsx")
print("Density_feature_importance_all_initial_with_temperature.xlsx")
print("Density_feature_importance_experimental_variables.xlsx")
print("Density_selected_features_balanced_original_values.xlsx")
print("Density_selected_features_balanced_original_values.csv")
print("Density_descriptor_comparison_comp1_comp2.xlsx")
print("Density_correlation_matrix_selected_features_original_values.xlsx")
print("Density_gridsearch_RF_results.xlsx")
print("Density_model_metrics_train_test.xlsx")
print("Density_cross_validation_metrics_RF.xlsx")
print("Density_feature_importance_final_selected_RF.xlsx")
print("Density_feature_importance_final_experimental_variables.xlsx")
print("Density_feature_importance_by_descriptor_family.xlsx")